...
local OriLua_LL_HVH_GBOX = gui.Groupbox(OriLua_TAB, "HvH", 10, 435, 470, 0) -- HvH-GBOX
...
local OriLua_LL_VISUALS_EXPOSURE = gui.Slider(OriLua_LL_VISUALS_GBOX, "OriLua_LL_VISUALS_BLOOM_EXPOSURE", "Night Mode", 100, 1, 100);
